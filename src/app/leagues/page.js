                ...
                items={[
                    {value:'standings',label:'Standings',
                        ...
                        <Table
                            ...
                            <TableHead>
                                <TableRow>
                                    <TableCell onClick={()=>requestSort('phasepoints')}>#</TableCell>
                                    ...
                                    <TableCell onClick={()=>requestSort('phasepoints')}>Phase points<Icon as={BiSolidSortAlt} /></TableCell>
                            ...
                            <TableBody>
                                {items.map((standing, index) => (
                                    <TableRow key={standing.teamName} onClick={()=>router.push(`/team/${standing.manager}`)}>
                                        ...
                                        <TableCell>{standing.phasepoints}</TableCell>
